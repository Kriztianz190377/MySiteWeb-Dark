...
import TC from '../assets/logo/Tip-calculator.webp'
...
export const Projects = () => {
  ...
  return (
    <div className=' container m-auto w-10/12 md:w-6/12' name='projects'>
      <div className=' '>
        <header className=' mb-5 '>
          <p className='capitalize font-bold text-4xl mb-5'>
            {projects.ptitle}
          </p>
        ...
        <main className='onlyProjects flex flex-wrap justify-between '>
          {projectsArray.map(projecUni => (
            <article
              key={projecUni.src}
              className='w-full sm:w-5/12 md:w-29 shadow-2xl '
            >
              <div className='py-8'>
